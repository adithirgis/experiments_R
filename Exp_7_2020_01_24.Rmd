...
library(openair)
library(plotly)
setwd("D:/Dropbox/APMfull/Colocation CSTEP/CSTEP_co-location_2020/Exp_7_2020_01_24")
reg_eqn<-function(x){
...
As per AethLabs microaethalometer measurements have a noise when measuring while it is being charged, for this experiment the chager was removed at ~18:30 hrs. Also all the measurements where ATN values above 120 were discarded, Status zero was only used.
